import React, { useState , yse} from 'react';
...
return url;
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={Isdefault?userDetails.url?userDetails.url:require('./../assets/images.jpg'):{uri:urlImage}} style={styles.userPhoto} />
      </TouchableOpacity>
