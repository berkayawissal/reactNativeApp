        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.groupItem} onPress={() => {
            navigation.navigate('ChatGroupe', {
              currentId: currentid, // Replace currentUserId with the actual user ID
              id_groupe: item.id, // Assuming item has a unique ID for the group
              nom_groupe: item.name, // Assuming item has a unique ID for the group
            });
          }} >
